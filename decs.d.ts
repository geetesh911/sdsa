declare module "astro-icon" {
  ...
  export function Icon(props: IconProps): void;
}
...
declare module "@astrolib/seo" {
  ...
  export function AstroSeo(props: AstroSeoProps): void;
}
declare module "@astrolib/analytics" {
  export interface Props {
    id: string;
    partytown: boolean;
  }
  export function GoogleAnalytics(props: Props): void;
}
